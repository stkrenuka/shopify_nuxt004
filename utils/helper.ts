...
export const upsellConfig = {
  offer1: {
    ...
    kitPrice: [{ kit: '1 - 3 Kits', price: '17.00' }, { kit: '4 - 6 Kits', price: '15.00' }, { kit: '7 - 12 Kits', price: '13.00' }],
  ...
  offer1_1: {
    ...
    productImg: "/images/offer1/up-1-img.jpg",
    kitPrice: [{ kit: '1 - 3 Kits', price: '16.00' }, { kit: '4 - 6 Kits', price: '14.00' }, { kit: '7 - 12 Kits', price: '12.00' }],
    submitBtnTitle: "COMPLETE CHECKOUT",
    event: "Purchase",
  ...
  offer2: {
    ...
    kitPrice: [{ kit: '1 - 3 Kits', price: '19.00' }, { kit: '4 - 6 Kits', price: '17.00' }, { kit: '7 - 12 Kits', price: '13.00' }],
    submitBtnTitle: "COMPLETE CHECKOUT",
    event: "Upsell1cv",
  ...
  offer2_1: {
    ...
    productImg: "/images/offer2/up-2-img.webp",
    kitPrice: [{ kit: '1 - 3 Kits', price: '18.00' }, { kit: '4 - 6 Kits', price: '16.00' }, { kit: '7 - 12 Kits', price: '12.00' }],
    submitBtnTitle: "COMPLETE CHECKOUT",
    event: "Upsell1cv",
  ...
  offer3: {
    ...
    kitPrice: [{ kit: '1 - 3 Kits', price: '19.95' }, { kit: '4 - 6 Kits', price: '17.95' }, { kit: '7 - 10 Kits', price: '12.95' }],
    submitBtnTitle: "COMPLETE CHECKOUT",
  ...
  offer3_1: {
    ...
    productImg: "/images/offer3/up-3-img.jpg",
    kitPrice: [{ kit: '1 - 3 Kits', price: '14.95' }, { kit: '4 - 6 Kits', price: '12.95' }, { kit: '7 - 10 Kits', price: '10.95' }],
    submitBtnTitle: "COMPLETE CHECKOUT",
